...
<tr class="table__row">
    ...
    <!-- Actions Dropdown -->
    <td
        class="table__cell table__cell--active"
    ...
    >
        ...
        >
            ...
            <!-- Dropdown Menu -->
            <div
                class="table__dropdown-container"
                x-show="dropdown"
                @click.stop
            >
                ...
                <!-- Mark As Option -->
                <button
                    class="table__dropdown-option table__dropdown-option--mark"
                    @click.stop
                >
                    <svg
                ...
                <form action="{{ route('admin.reservations.show', ['reservation' => $booking->id]) }}">
                    <button
                        class="table__dropdown-option table__dropdown-option--view"
                        type="submit"
                        @click.stop
                    >
                        <svg
                ...
                <!-- Delete Option -->
                <button
                    class="table__dropdown-option table__dropdown-option--delete"
                    @click.stop="confirmDelete({{ $booking->id }})"
                >
                    <svg
                        xmlns="http://www.w3.org/2000/svg"
                        width="24"
