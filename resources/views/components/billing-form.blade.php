...
<div class="billing-form">
    ...
    <form class="billing-form__form"
        ...
        <div class="billing-form__group-layout">
            @auth
                <x-billing-form-group id="first_name"
                    name="first_name"
                    type="text"
                ...
                <x-billing-form-group id="last_name"
                    name="last_name"
                    type="text"
            ...
            @guest
                ...
                <x-billing-form-group id="phone_no"
                    name="phone_no"
                    type="phone">Phone Number</x-billing-form-group>
            @endguest
